...
def all_modules_subpattern():
    ...
    ret += u" | "
    ret += u" | ".join([simple_name.format(name=mod[0]) for mod in names_dot_attrs if mod[1] == u"__init__"]) + u" )"
    return ret
